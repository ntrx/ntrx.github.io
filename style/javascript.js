function view(x,y,name) {
	newwin = window.open("","_blank","width=800,height=600,scrollbars=1",1);
	...
	newwin.document.write('<html><head><title>Screen</title></head>'+
						  ...
						  '<center><img src='+name+' style="margin-top:0px;" align=absmiddle></center>'+
						  '</body></html>');
	newwin.document.close();
}
function view2(x,y,name) {
	newwin = window.open("","_blank","width=640,height=480,scrollbars=1",1);
	newwin.document.open();
	newwin.moveTo(0,0);
	newwin.document.write('<html><head><title>Photo</title></head>'+
						  '<body leftmargin=0 topmargin=0 marginwidth=0 marginheight=0 align=center bgcolor=#666666 style="overflow:auto;">'+
						  '<center><img src='+name+' style="margin-top:0px;" align=absmiddle></center>'+
						  '</body></html>');
	newwin.document.close();
